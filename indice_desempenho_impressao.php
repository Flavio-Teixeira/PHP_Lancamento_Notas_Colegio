...
function PDF_Detalhe()
{
   ...
   $comando_sql .= "planilha_coluna_g_coddisciplina ASC, ";
   ...
   if(mysql_num_rows($resultado_sql) != 0)
   {
     ...
     $pdf->SetName("ÍNDICE DE DESEMPENHO DO ALUNO",trim($planilha_ano),trim($planilha_turma),trim($planilha_disciplina));
